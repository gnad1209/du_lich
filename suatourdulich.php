...
<table width="600" border="0" class="tanle" align="center">
  ...
  <tr>
	...
	<td class="btnsuaxoa" align="center"><a href="index.php?suatourdulich=<?php echo $rows['matour']; ?>">Sửa</a></td>
	<td class="btnsuaxoa" align="center"><a href="index.php?xoatourdulich=<?php echo $rows['matour']; ?>">Xóa</a></td>
  </tr>
  <?php
		}
  ?>
