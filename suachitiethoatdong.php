...
?>
      <tr>
        ...
        <td class="btnsuaxoa" align="center"><a href="index.php?suahoatdong=<?php echo $rows['id_hd'];?>">Sửa</a></td>
        <td class="btnsuaxoa" align="center"><a href="index.php?xoahoatdong=<?php echo $rows['id_hd'];?>">Xóa</a></td>
      </tr>
      <?php
	}
		?>
