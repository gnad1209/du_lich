  ...
  <div align="center">
    <table width="622" border="0">
      ...
      <tr>
        ...
        <td class="btnsuaxoa" align="center"><a href="index.php?suanhahang=<?php echo $rows['manh'];?>">Sửa</a></td>
        <td class="btnsuaxoa" align="center"><a href="index.php?xoanhahang=<?php echo $rows['manh'];?>">Xóa</a></td>
      </tr>
      <?php
	  }
	  ?>
