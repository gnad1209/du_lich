 ...
 <div align="center">
    <table width="600" border="0">
      ...
      <tr>
        ...
        <td class="btnsuaxoa" align="center"><a href="index.php?suatainguyen=<?php echo $rows['matn'];?>">Sửa</a></td>
        <td class="btnsuaxoa" align="center"><a href="index.php?xoatainguyen=<?php echo $rows['matn'];?>">Xóa</a></td>
      </tr>
      <?php
	  }
	  ?>
