...
<table width="600" border="0" class="tanle">
  ...
  <tr>
    ...
    <td class="btnsuaxoa" align="center"><a href="index.php?sua=<?php echo $rows['maks']; ?>">Sửa</a></td>
    <td class="btnsuaxoa" align="center"><a href="index.php?xoa=<?php echo $rows['maks']; ?>">Xóa</a></td>
  </tr>
  <?php
		}
  ?>
