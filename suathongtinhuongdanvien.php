 ...
 <div align="center">
    <table width="622" border="0">
      ...
      <tr>
        ...
        <td class="btnsuaxoa" align="center"><a href="index.php?suahdv=<?php echo $rows['mahdv'];?>">Sửa</a></td>
        <td class="btnsuaxoa" align="center"><a href="index.php?xoahdv=<?php echo $rows['mahdv'];?>">Xóa</a></td>
      </tr>
      <?php
	  }
	  ?>
