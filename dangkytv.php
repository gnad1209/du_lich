...
if (isset($_POST['btnregister'])) {
	...
	$sql = "INSERT INTO thanhvien(username,tentv,ngaysinh,diachi,sodt,anh,password) values('$u','$n',CONCAT('$y','-','$m','-','$d'),'$c','$dt','{$_FILES['upload']['name']}','$p')";
...
<form action="" method="post" name="frmregister" onSubmit="return checkInput();" enctype="multipart/form-data">
	<div align="center">
		<table width="600" height="425" border="0">
			<tr>
				<td height="31" colspan="2" bgcolor="#66FFFF">
					<p class="dangky"><b>ĐĂNG KÝ THÀNH VIÊN</b></p>
				</td>
			</tr>
			<tr>
				<td height="23" colspan="2">
					<p class="thongtin">Những thông tin có đánh dấu <font color="#FF0000">*</font>là bắt buộc</p>
				</td>
			</tr>
			<tr>
				<td colspan="2"><b>
						<font color="#0099FF">Thông Tin Cá Nhân</font>
					</b></td>
			</tr>
			<tr>
				<td width="138">Họ Tên<font color="#FF0000">*</font>
				</td>
				<td width="417"><input type="text" name="txtname" id="textfield" size="45"></td>
			</tr>
			<tr>
				<td>Ngày Sinh<font color="#FF0000">*</font>
				</td>
				<td><select name="cbbday" class="select">
						<option>[Ngày]</option>
						<?php for ($day = 1; $day <= 31; $day++) { ?>
							<option><?php echo "$day \n"; ?></option>
						<?php } ?>
					</select>
					<select name="cbbmonth" class="select">
						<option>[Tháng]</option>
						<?php for ($month = 1; $month <= 12; $month++) { ?>
							<option><?php echo "$month \n"; ?></option>
						<?php } ?>
					</select>
					<select name="cbbyear" class="select">
						<option>[Năm]</option>
			...
			<tr>
				<td>Dịa Chỉ</td>
				<td><select name="cbbcountry" class="select">
						<option>-----</option>
			...
			<tr>
				<td colspan="2"><b>
						<font color="#0099FF"> Thông tin tài khoản</font>
					</b></td>
			</tr>
			<tr>
				<td rowspan="2">Username<font color="#FF0000">*</font>
				</td>
			...
			<tr>
				<td>Password<font color="#FF0000">*</font>
				</td>
				<td><input type="password" name="txtpass" size="45"></td>
			</tr>
			<tr>
				<td>Xác nhận Password<font color="#FF0000">*</font>
				</td>
			...
			<tr>
				<td height="68" colspan="2"><input type="submit" name="btnregister" value="" class="btndangky">
					<input type="button" name="btnreset" value="" onClick="thoat();" class="btnthoat">
				</td>
			</tr>
		</table>
	</div>
